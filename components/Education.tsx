    ...
    <div className="w-full max-w-7xl mx-auto">
       ...
       <div className="flex items-end justify-between mb-20 border-b border-white/20 pb-8">
        <div>
           ...
           <p className="text-blue-300 text-sm md:text-lg font-bold tracking-[0.2em] uppercase">Academic & Professional</p>
        </div>
      ...
      <div className="space-y-16">
        ...
        <div className="group relative bg-slate-900/60 border border-white/20 p-10 md:p-16 rounded-2xl backdrop-blur-sm transition-all duration-500 hover:border-red-600/60 hover:bg-slate-900/90">
            {/* Visual Corner Accents */}
            <div className="absolute top-0 left-0 w-6 h-6 border-t-4 border-l-4 border-white/30 group-hover:border-red-600 transition-colors rounded-tl-xl"></div>
            <div className="absolute bottom-0 right-0 w-6 h-6 border-b-4 border-r-4 border-white/30 group-hover:border-red-600 transition-colors rounded-br-xl"></div>
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-12 gap-6">
                ...
                <div className="px-6 py-3 bg-red-600/20 border border-red-600/30 rounded text-red-400 text-sm md:text-base font-bold tracking-widest uppercase whitespace-nowrap shadow-[0_0_15px_rgba(220,38,38,0.2)]">
                    2024 — Present
                </div>
            </div>
                    ...
                    <ul className="grid grid-cols-1 gap-y-4 text-base md:text-xl text-white">
                        {[
                            ...
                            <li key={course} className="flex items-center gap-4 group/item">
                                <span className="w-2.5 h-2.5 bg-red-600 rounded-full group-hover/item:scale-125 transition-transform"></span>
                                <span className="group-hover/item:text-red-400 transition-colors">{course}</span>
                            </li>
                        ))}
                    </ul>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-base md:text-xl text-white">
                    {[
                        ...
                        <div key={i} className="flex items-start gap-3">
                            <svg className="w-6 h-6 text-blue-400 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7" /></svg>
                            <span>{item}</span>
                        </div>
                    ))}
                </div>
        ...
        <div className="group relative bg-slate-900/60 border border-white/20 p-10 md:p-14 rounded-2xl backdrop-blur-sm transition-all duration-500 hover:border-sky-500/60 hover:bg-slate-900/90">
             {/* Visual Corner Accents - Blue */}
            <div className="absolute top-0 left-0 w-6 h-6 border-t-4 border-l-4 border-white/30 group-hover:border-sky-500 transition-colors rounded-tl-xl"></div>
            <div className="absolute bottom-0 right-0 w-6 h-6 border-b-4 border-r-4 border-white/30 group-hover:border-sky-500 transition-colors rounded-br-xl"></div>
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-8 gap-6">
                ...
                <div className="px-6 py-3 bg-sky-500/20 border border-sky-500/30 rounded text-sky-400 text-sm md:text-base font-bold tracking-widest uppercase whitespace-nowrap shadow-[0_0_15px_rgba(14,165,233,0.2)]">
                    2025 — Present
                </div>
            </div>
                     ...
                     <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-base md:text-xl text-white">
                        {[
                            ...
                            <li key={skill} className="flex items-center gap-3 group/skill">
                                <svg className="w-5 h-5 text-sky-400 flex-shrink-0 group-hover/skill:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                                <span className="group-hover/skill:text-sky-300 transition-colors">{skill}</span>
                            </li>
                        ))}
                     </ul>
                </div>
